...
const COMMON_PACKAGES: &[(&str, &str, u64)] = &[
    ("firefox", "121.0-1", 200_000_000),
    ("chromium", "120.0.6099.109-1", 300_000_000),
    ("vim", "9.0.2136-1", 15_000_000),
    ("git", "2.43.0-1", 30_000_000),
    ("curl", "8.5.0-1", 500_000),
    ("openssh-client", "9.6p1-1", 2_000_000),
    ("python3", "3.12.1-1", 50_000_000),
    ("nodejs", "20.10.0-1", 30_000_000),
    ("docker-ce", "24.0.7-1", 50_000_000),
    ("nginx", "1.24.0-2", 1_500_000),
    ("htop", "3.3.0-1", 200_000),
    ("tmux", "3.3a-4", 500_000),
    ("build-essential", "12.10", 10_000_000),
    ("libssl-dev", "3.0.13-1", 8_000_000),
    ("zsh", "5.9-6", 5_000_000),
    ("neovim", "0.9.5-1", 20_000_000),
];
...
impl Default for InstallGenerator {
    fn default() -> Self {
        Self::new()
    }
}
